...
class PyTitleBar(QWidget):
    ...
    def setup_ui(self):
        ...
        self.pixmap = QPixmap(Functions.set_image(self._logo_image))
        self.logo_svg.setPixmap(self.pixmap)
        self.logo_svg.setScaledContents(True)
        self.logo_svg.resize(self.pixmap.width(), self.pixmap.height())
